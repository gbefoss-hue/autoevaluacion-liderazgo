...
const START_MESSAGE_LINE_3 = 'Volvé a tu infancia por un rato y tratá de conseguir los elementos que querés que se incluyan...';
...
class StartScene extends Phaser.Scene {
    ...
    create() {
        ...
        buttonRect.setInteractive()
            ...
            .on('pointerover', () => buttonRect.fillColor = 0x81E6D9) // Color más claro al pasar el mouse
            .on('pointerout', () => buttonRect.fillColor = 0x4FD1C5); // Vuelve al color original
    }
}
...
class GameOverScene extends Phaser.Scene {
    ...
    create() {
        ...
        // --- BOTÓN CON RECTÁNGULO Y TEXTO MODIFICADO ---
